...
const ConversationPage = () =>{
    ...
    const onSubmit = async ( values: z.infer<typeof formSchema>) => {
        try{
            ...
            //TODO: use middleware that will detect expired free trial at a global scale
            ...
            //this refetches the server component
            // and will flect backend changes e.g. db changes
            //rehydrates all server components
            router.refresh();
        }
    }
